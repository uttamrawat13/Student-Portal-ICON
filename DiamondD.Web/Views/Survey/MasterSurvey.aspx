...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="pageContent">
        <div class="TitleAndNewDiv">
            <span class="MainHeadingSpan"><h1>Surveys</h1></span> 
        </div>
        
        <div class="GridDiv">
        <span class="NewLinkSpan">
                <%:Html.ActionLink("New","CreateSurvey")%></span>
            <%
                var grid = new JqGridHelper<SurveyGridViewModel>(
                "surveys",
                ...
                url: Page.ResolveUrl(AppHelper.SurveysUrl("ListSurvey")), //Url.Action("ListSurvey"),
