...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <div  class="DivRowwidth1000">
    ...
    <span id="SuccessfulMsg" class="SuccessMsgDisplayNone"><asp:Localize ID="SuccessfulChangeMsg" runat="server" meta:resourceKey="SuccessfulChangeMsg" /></span>
    
    <!------------   Change Password   ------------->
    
    <div id="changePasswordDiv" class="width700px">
    	        <fieldset id="changePasswordLegend">
										...
										<table cellpadding="0" border="0" >
										        <tr>
                                                    ...
                                                    <asp:Localize ID="SectionTitleChangePassword" runat="server" meta:resourceKey="SectionTitleChangePassword" /></span></td>
			                                    </tr>
										        <tr>
			                                    ...
			                                    <tr>
				                                    ...
				                                    <td>
                                                          ...
                                                          <span id="enterOldPasswordErr" class="DisplayNoneErrorMsg"><asp:Localize ID="EnterOldPasswordErrorMsg" runat="server" meta:resourceKey="EnterOldPasswordErrorMsg" /></span>
                                                    </td>
                                                    <td>
                                                    </td>
			                                    </tr>
			                                    <tr>
				                                    ...
				                                    <td>
                                                          ...
                                                          <span id="enterNewPasswordErr" class="DisplayNoneErrorMsg"><asp:Localize ID="EnterNewPasswordErrorMsg" runat="server" meta:resourceKey="EnterNewPasswordErrorMsg" /></span>
                                                    </td>
                                                    <td>
                                                    </td>
			                                    </tr>
			                                     <tr>
				                                    ...
				                                    <td>
                                                          ...
                                                          <span id="enterConfirmPasswordErr" class="DisplayNoneErrorMsg"><asp:Localize ID="EnterConfirmPasswordErrorMsg" runat="server" meta:resourceKey="EnterConfirmPasswordErrorMsg" /></span>
                                                    </td>
                                                    <td>
                                                    </td>
			                                    </tr>
			                                    <tr>
				                                    ...
				                                    <td></td>
				                                    <td>
                                                          <span id="compareBothPasswordSameErr" class="DisplayNoneErrorMsg"><asp:Localize ID="PasswordsMismatchErrorMsg" runat="server" meta:resourceKey="PasswordsMismatchErrorMsg" /></span>
                                                          <span id="oldPasswordNotMatch" class="DisplayNoneErrorMsg"><asp:Localize ID="oldPasswordNotMatchMsg" runat="server" meta:resourceKey="oldPasswordNotMatchMsg" /></span>
                                                    </td>
                                                    <td>
                                                    </td>
			                                    </tr>
	...
	<div id="ChangeScretQuestionDiv" class="width700px">
    	        <fieldset id="ChangeSecretQuestionLegend">
                                             <% using (Html.BeginForm("ChangeSecretQuestion", "User"))
                                                { %>
										<table cellpadding="0" border="0" >
										        <tr>
				                                    <td colspan="4" align="center"><span class="BlueHeading">
                                                    <asp:Localize ID="SectionTitleChangeSecretQuestion" runat="server" meta:resourceKey="SectionTitleChangeSecretQuestion" /></span></td>
			                                    </tr>
										        <tr>
				                                    <td align="right" valign="middle" class="width200px" ></td>
				                                    <td class="width10px"></td>
			                                    ...
			                                    <tr>
				                                    ...
				                                    <td></td>
				                                    <td>
                                                          <input id="txtSecretQuestion" name="txtSecretQuestion" value="<%= Model.SecretQuestion %>" type="text" maxlength="200" disabled="disabled" class="width360px" />
			                                     ...
			                                     <tr>
				                                    ...
				                                    <td></td>
				                                    <td>
                                                          <span id="enterSecretQuestionErr" class="DisplayNoneErrorMsg"><asp:Localize ID="EnterSecretQuestionErrorMsg" runat="server" meta:resourceKey="EnterSecretQuestionErrorMsg" /></span>
                                                    </td>
                                                    <td>
                                                    </td>
			                                    </tr>
			                                    <tr>
				                                    ...
				                                    <td></td>
				                                    <td>
                                                          <input id="txtSecretAnswer" name="txtSecretAnswer" value="<%= Model.SecretAnswer %>" type="text" maxlength="200" disabled="disabled"  class="width360px"/>
			                                    ...
			                                    <tr>
				                                    ...
				                                    <td></td>
				                                    <td>
                                                          <span id="enterSecretAnswerErr" class="DisplayNoneErrorMsg"><asp:Localize ID="EnterSecretAnswerErrorMsg" runat="server" meta:resourceKey="EnterSecretAnswerErrorMsg" /></span>
	...
	<div id="ChangeEmailDiv" class="width700px">
    	        <fieldset id="ChangeEmailLegend">
										...
										<table cellpadding="0" border="0" >
			                                    ...
			                                    <tr>
				                                    ...
				                                    <td></td>
				                                    <td>
                                                          <input id="txtChangeEmail" name="txtChangeEmail" value="<%= Model.Email %>" type="text" maxlength="200" disabled="disabled" class="width360px" />
			                                    ...
			                                    <tr>
				                                    ...
				                                    <td></td>
				                                    <td>
                                                          <span id="enterEmailErr" class="DisplayNoneErrorMsg"><asp:Localize ID="EnterEmailAddressErrorMsg" runat="server" meta:resourceKey="EnterEmailAddressErrorMsg" /></span>
                                                    </td>
                                                    <td>
                                                    </td>
			                                    </tr>
			                                     <tr>
				                                    ...
				                                    <td></td>
				                                    <td>
                                                          <span id="invalidEmailErr" class="DisplayNoneErrorMsg"><asp:Localize ID="InvalidEmailAddressErrorMsg" runat="server" meta:resourceKey="InvalidEmailAddressErrorMsg" /></span>
                                                    </td>
                                                    <td>
                                                    </td>
			                                    </tr>
