...
/****** Object:  View [dbo].[vWebCosmetologyGradeBookTest]    Script Date: 03/30/2011 15:28:40 ******/
SET ANSI_NULLS ON
GO
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      ...
      Begin ColumnWidths = 12
         ...
         GroupBy = 1350
         Filter = 1350
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vWebCosmetologyGradeBookTest'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=2 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vWebCosmetologyGradeBookTest'
GO
