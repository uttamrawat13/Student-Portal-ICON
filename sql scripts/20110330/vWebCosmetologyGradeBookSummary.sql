...
/****** Object:  View [dbo].[vWebCosmetologyGradeBookSummary]    Script Date: 03/30/2011 15:28:18 ******/
SET ANSI_NULLS ON
GO
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vWebCosmetologyGradeBookSummary'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vWebCosmetologyGradeBookSummary'
GO
